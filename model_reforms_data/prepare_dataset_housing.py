...
def prepare_dataset_housing(survey):
    ...
    try:
        df_hh = pd.read_csv(r'C:\Users\t.douenne\Documents\Github\yellow_vests_aej_ep\model_reforms_data\data_matching_{}.csv'.format(survey))
    except:
        try:
            ...
            try:
                ...
                df_hh = pd.read_csv(r'C:\Users\thoma\Documents\Github\yellow_vests_aej_ep\model_reforms_data\data_matching_{}.csv'.format(survey))
...
if __name__ == "__main__":
    df_hh = prepare_dataset_housing('enl') # Alternative argument: 'bdf' to use the consumer survey instead of the housing survey
