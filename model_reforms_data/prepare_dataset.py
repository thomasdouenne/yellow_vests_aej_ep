...
def prepare_dataset():
    ...
    try:
        df_hh = pd.read_csv(r'C:\Users\t.douenne\Documents\Github\yellow_vests_aej_ep\model_reforms_data\data_menages.csv')
    except:
        try:
            ...
            try:
                ...
                df_hh = pd.read_csv(r'C:\Users\thoma\Documents\Github\yellow_vests_aej_ep\model_reforms_data\data_menages.csv')
    ...
    df_hh['diesel_expenditures'] = (36916.0 / 33412) * df_hh['diesel_expenditures']
    df_hh['gasoline_expenditures'] = (36916.0 / 33412) * df_hh['gasoline_expenditures']
