library("StatMatch")
# Import data
df_donor_enl <- read.csv(file = "C:/Users/thoma/Documents/Github/yellow_vests_aej_ep/df_donor_enl.csv", header = -1, sep=";")
df_receiver_bdf <- read.csv(file = "C:/Users/thoma/Documents/Github/yellow_vests_aej_ep/df_receiver_bdf.csv", header = -1, sep=";")
...
out.nnd <- NND.hotdeck(
  ...
  don.class = c("natural_gas", "domestic_fuel"),
  dist.fun = "Gower"
)
